...
Department = _models_module.Department
Employee = _models_module.Employee
Project = _models_module.Project
...
def main() -> None:
    ...
    with manager.session() as session:
        ...
        projects = [
            (
                "AI Forecasting",
                "Predictive analytics for sales and staffing",
                "Research",
                "2024-05-01",
                "2025-01-31",
                "active",
            ...
            (
                "Customer Onboarding 2.0",
                "Reduce time-to-value with guided flows",
                "Customer Success",
                "2024-02-15",
                "2024-10-31",
                "active",
            ...
            (
                "IT Service Desk Revamp",
                "Upgrade ticketing and knowledge base",
                "IT Support",
                "2024-01-10",
                "2024-07-31",
                "completed",
            ...
            (
                "Ops Automation",
                "Automate recurring finance ops tasks",
                "Operations",
                "2024-03-05",
                "2024-12-15",
                "active",
            ...
            (
                ...
                "Prepare for annual compliance audit",
                "Legal",
                "2024-04-01",
                "2024-09-30",
                "planning",
