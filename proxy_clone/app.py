...
feature_enabled = create_feature_enabled_decorator(runtime.config.proxy_features_enabled)
...
def build_api_blueprint_dependencies() -> ProxyApiBlueprintDependencies:
    return ProxyApiBlueprintDependencies(
